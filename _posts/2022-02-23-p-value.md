...
categories: ['stats']
author: rmirfa
image: assets/images/posts/p_value/p_value.png
---

La definición formal de p-valor es:

> El p-valor (p-value en inglés) es el nivel de significación mínimo no arbitrario con el que podemos rechazar la hipótesis nula (H0) dada una función de distribución y un estadístico de contraste.
...
<div class="image_center mb-4 mt-2">
    <img src="/assets/images/posts/p_value/error_types.jpg" alt="error types" style="max-width: 100%; max-height: 100%; height: 380px"/> 
</div>
...
$$Z = \frac{\bar{X}-\mu}{\sigma / \sqrt{n}} = \frac{40500 - 40000}{1650/ \sqrt{30}} =  1.66$$
...
> Si $$\alpha \geq \text{p-valor}$$, se <span style="color: blue">acepta H0 </span> <br>
> Si $$\alpha < \text{p-valor}$$, se <span style="color: blue">rechaza H0</span>
